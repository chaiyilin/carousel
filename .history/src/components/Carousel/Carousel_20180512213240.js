  ...
  swipeableViewsHoc = Swipeable => {
    ...
    return (
      <div>
        ...
        <Pagination dots={slidesCount} index={index} onChangeIndex={this.handleChangeIndex} />
      </div>
    );
  };

  render() {
    const Swipeable = this.state.allowAutoRePlay
      ? this.swipeableViewsHoc(AutoPlaySwipeableViews)
      : this.swipeableViewsHoc(VirtualizeSwipeableViews);
